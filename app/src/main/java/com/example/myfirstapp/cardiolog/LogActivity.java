...
import com.example.myfirstapp.model.Exercise;
import com.example.myfirstapp.model.LogEntry;
...
public class LogActivity extends Activity implements OnValueChangeListener, NumberPicker.OnScrollListener, View.OnClickListener {
    ...
    // Application State
    private Map<LocalDate, ArrayList<LogEntry>> logs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logs = new HashMap<LocalDate, ArrayList<LogEntry>>();
    ...
    private void persistCurrentLogs() {
        ...
        File file = new File(dir, new org.joda.time.LocalDate().toString("yyyy-MM-dd") + ".json");
    ...
    private StringBuilder builderForLogs(Map<LocalDate, ArrayList<LogEntry>> logs) {
...
Collections.sort(dates, new Comparator<LocalDate>(){
    ...
    public int compare(LocalDate o1, LocalDate o2) {
        try {
            return f.parse(String.valueOf(o1)).compareTo(f.parse(String.valueOf(o2)));
    ...
    private static class LoadLogData extends AsyncTask<Void, Void, LoadLogData.Output> {
        ...
        public static class Output {
            Map<LocalDate, ArrayList<LogEntry>> logs = new HashMap<LocalDate, ArrayList<LogEntry>>();
            BigDecimal b;
            BigDecimal m;
        }
        ...
        protected Output doInBackground(Void... params) {
            ...
            try {
                ...
                org.joda.time.format.DateTimeFormatter pattern = DateTimeFormat.forPattern("MM/dd/yyyy HH:mm:ss");

                output.logs = new HashMap<LocalDate, ArrayList<LogEntry>>();
                ...
                for (int i = 0; i < 50 && i < files.length && trackedEntries < previousEntries; i++) {
                    ...
                    ArrayList<LogEntry> logs = gson.fromJson(json, collectionType);
